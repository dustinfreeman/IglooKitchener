...
#Dustin's minor modification of the Vizard Shadow module
#For perspective shadows
...
class ShadowProjector(object):
	...
	def setArea(self,area):
		...
		#may not correctly place shadow in the right position.
		#maybe need a bigger FOV?
